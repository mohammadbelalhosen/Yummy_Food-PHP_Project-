...
$select = "SELECT f.id,f.food_name,f.food_des,f.food_price,f.food_img_name,f.catagory_id,c.catagory FROM foods f INNER JOIN catagories c ON f.catagory_id=c.id";
    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td>
                    <a class="btn btn-info" style="font-size:smaller" href="">Edit</a></a>
