...
$query = "SELECT * FROM gallery_section";
...
<table class="table">
    ...
    <tbody>
        ...
        ?>
            <tr>
                <th scope="row"><?= ++$key ?></th>
                <td><img style="width:150px;" src="<?= './uploads/gallery_section/' . $result['gallery_img'] ?>" alt=""></td>
                <td>
                ...
                <td>
                    <a class="btn btn-primary" style="font-size:smaller" href="../controller/gallery_status.php?id=<?= $result['id'] ?>"><?= $result['status'] != 0 ? "De-Active" : "Active" ?></a></a>
                    <a class="btn btn-danger deletebanner" style="font-size:smaller" href="../controller/gallery_delete.php?id=<?= $result['id'] ?>">Delete</a></a>
                </td>
            </tr>
