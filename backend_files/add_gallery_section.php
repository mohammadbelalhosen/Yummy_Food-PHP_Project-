...
?>
    <div class="toast show" role="alert" aria-live="assertive" aria-atomic="true" style="z-index:1;position:absolute;top:10px;right:10px">
        <div class="toast-header">
            <strong class="me-auto">Add Gallery</strong>
...
<div class="card">
    ...
    <div class="card-body">
        <form action="../controller/add_gallery_section.php" method="POST" enctype="multipart/form-data">
            <div class="col-5">
                ...
                <label for="img_banner">
                    ...
                    <input type="file" class="d-none imageInput" name="gallery_img" id="img_banner">
                </label>
                <?php
                if (isset($_SESSION['errors']['gallery_img_er'])) {
                ?>
                    <span class="text-danger">
                        <?= $_SESSION['errors']['gallery_img_er'] ?>
                    </span>
                <?php
                }
                ?>
            </div>
            <button type="submit" class="btn btn-primary float-left w-100" name="submit">Add Gallery</button>
